...
type HotelPackage = Hotel['packages'][number];
...
- suggestedVibe: El estilo seleccionado (${styleName}).`,
      ...
      const result = JSON.parse(text) as AIConcept;

      setAiConcept(result);
      setSelections((prev) => ({
        ...prev,
        vision: styleName,
        vibe: result.suggestedVibe || prev.vibe,
      }));
  ...
  const getSelectionSummary = () => {
    const perks = [
      ...
      .filter((p) => selections.guests >= p.min)
      .map((p) => p.label)
      .join(', ');

    return (
      `*Resumen de Diseño Flymingo*%0A%0A` +
  ...
  const calendlyUrl = `https://calendly.com/flymingo/flymingo-weddings?a1=${encodeURIComponent(
    getSelectionSummary().replace(/%0A/g, '\n')
  )}`;
  ...
  const renderStep = () => {
    switch (step) {
        ...
        return (
          ...
          >
            <div className="space-y-6 md:space-y-8 max-w-4xl">
              ...
              >
                <h2 className="text-brand-gold uppercase tracking-[0.4em] md:tracking-[0.6em] text-[10px] md:text-xs font-bold mb-4 md:mb-6">
                  The Future of Destination Weddings
                </h2>
                <h1 className="text-7xl md:text-[10rem] font-serif leading-[0.8] tracking-tighter">
                  FLY<span className="italic text-brand-gold">MINGO</span>
                  <br />
                  <span className="text-5xl md:text-8xl tracking-normal opacity-90">
                    DESIGNER
                  </span>
                </h1>
              </motion.div>
              <p className="text-lg md:text-2xl text-brand-dark/50 font-light max-w-2xl mx-auto leading-relaxed px-4">
                ...
                <span className="text-brand-gold font-medium border-b border-brand-gold/30 pb-1">
                  Pioneros en innovación nupcial.
                </span>
              </p>
            </div>
            ...
            <div className="flex flex-col items-center gap-8 w-full max-w-md mx-auto">
              <div className="w-full space-y-4">
                ...
                >
                  <span className="relative z-10 font-bold tracking-[0.3em] uppercase text-[10px] md:text-xs">
                    Iniciar Experiencia AI
                  </span>
          ...
          <div className="max-w-7xl mx-auto space-y-12 md:space-y-20 py-6 md:py-12 px-4">
            <div className="space-y-4 md:space-y-6 text-center">
              ...
              <p className="text-brand-dark/50 font-light text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                Selecciona la esencia que mejor represente su historia de amor. Nuestra IA diseñará
                un concepto a medida.
              </p>
            </div>
                      ...
                      {isGenerating && selections.vibe === style.id && (
                        <div className="absolute inset-0 bg-brand-dark/90 backdrop-blur-sm flex flex-col items-center justify-center space-y-6 z-50">
                          ...
                          <div className="space-y-2">
                            <span className="text-xs font-bold uppercase tracking-[0.4em] text-brand-gold block">
                              Diseñando Legado
                            </span>
                            <span className="text-[10px] text-white/40 uppercase tracking-widest">
                              Consultando con Flymingo AI...
                            </span>
                          </div>
                        </div>
                      )}
          ...
          <div className="space-y-16 md:space-y-24 px-4 py-6">
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-10 md:gap-16 items-center">
                  ...
                  <div className="space-y-6 md:space-y-8 text-center md:text-left">
                    <div className="space-y-2">
                      ...
                      <h4 className="text-4xl md:text-7xl font-serif italic leading-none tracking-tighter">
                        "{aiConcept.name}"
                      </h4>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                      {aiConcept.keyElements.map((el, i) => (
                        <span
                          key={i}
                          className="px-5 py-2 bg-brand-dark text-white/90 rounded-full text-[9px] md:text-[11px] font-bold uppercase tracking-[0.2em] shadow-lg"
                        >
                          {el}
                        </span>
                      ))}
            ...
            <div className="text-center space-y-6">
              <h2 className="text-5xl md:text-8xl font-serif leading-none tracking-tighter">
                ¿Dónde sucederá <br />
                <span className="text-brand-gold italic">la magia?</span>
              </h2>
              <p className="text-brand-dark/40 uppercase tracking-[0.4em] text-[10px] md:text-xs font-bold">
                Selecciona el escenario perfecto
              </p>
            </div>
              ...
              {DESTINATIONS.map((dest) => (
                <button
                  ...
                  className={cn(
                    ...
                    selections.destination === dest
                      ? 'ring-8 ring-brand-gold/30 scale-[0.98]'
                      : 'hover:scale-[1.02] luxury-shadow'
                  )}
                >
                  <img
                  ...
                  <div className="absolute bottom-10 left-10 md:bottom-16 md:left-16 text-left space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-brand-gold text-[10px] md:text-xs font-bold uppercase tracking-[0.5em]">
                        Destino
                      </span>
                    </div>
        ...
        return (
          <div className="max-w-4xl mx-auto space-y-12 md:space-y-20 py-6 md:py-12 px-4">
            <div className="space-y-6 md:space-y-8 text-center">
              ...
              <h2 className="text-5xl md:text-8xl font-serif leading-none tracking-tighter">
                ¿Cuántos <br />
                <span className="text-brand-gold italic">acompañantes?</span>
              </h2>
              <p className="text-brand-dark/40 text-lg md:text-xl font-light max-w-xl mx-auto">
                El tamaño de tu grupo desbloquea beneficios exclusivos en nuestra selección de
                hoteles.
              </p>
            </div>
            ...
            <div className="space-y-16 md:space-y-24">
              <div className="relative py-12 md:py-20">
                <div className="text-center mb-12 md:mb-16">
                  ...
                  <span className="text-brand-gold text-2xl md:text-4xl font-serif italic ml-4">
                    Invitados
                  </span>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
                <div className="bg-brand-dark text-white p-10 md:p-16 rounded-[3rem] md:rounded-[4rem] space-y-8 md:space-y-12 relative overflow-hidden shadow-2xl">
                  ...
                  <div className="space-y-2 relative z-10">
                    <h3 className="text-brand-gold text-[10px] font-bold uppercase tracking-[0.4em]">
                      Flymingo Unlocker
                    </h3>
                  ...
                  <div className="space-y-6 md:space-y-8 relative z-10">
                    {[
                      {
                        min: 10,
                        label: 'Ceremonia Complementaria',
                        icon: Heart,
                        desc: 'Tu unión, nuestro regalo.',
                      },
                      {
                        min: 25,
                        label: 'Habitaciones de Cortesía',
                        icon: Gift,
                        desc: 'Estancia premium para los novios.',
                      },
                      {
                        min: 50,
                        label: 'Evento Privado Flymingo',
                        icon: Sparkles,
                        desc: 'Coctel de bienvenida exclusivo.',
                      },
                      {
                        min: 100,
                        label: 'Upgrades VIP & Suite',
                        icon: Zap,
                        desc: 'Lujo máximo para tu grupo.',
                      },
                    ].map((benefit, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="space-y-1">
                            ...
                            <span className="text-[9px] text-brand-gold/60 font-bold uppercase tracking-tighter">
                              Mínimo {benefit.min} PAX
                            </span>
                          </div>
                          {isUnlocked && (
                            <motion.div
                ...
                <div className="flex flex-col justify-center items-center p-10 md:p-16 bg-white/60 backdrop-blur-xl rounded-[3rem] md:rounded-[4rem] border border-white/40 text-center space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-brand-dark/50 font-light leading-relaxed">
                      Nuestra IA está lista para presentarte la mejor selección de hoteles en{' '}
                      {selections.destination} que se adaptan a tu estilo {selections.vision}.
                    </p>
                  </div>
                  <button
          ...
          <div className="space-y-8 md:space-y-16 px-4">
            <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-6 md:gap-8 border-b border-brand-dark/10 pb-8 md:pb-16">
              <div className="space-y-4 md:space-y-6 text-center md:text-left">
                <h2 className="text-5xl md:text-7xl font-serif leading-none">
                  Curaduría <span className="italic text-brand-gold">Elite</span>
                </h2>
                <p className="text-brand-dark/40 max-w-lg text-base md:text-lg font-light leading-relaxed">
                  Selección exclusiva basada en tu visión AI y logística de grupo. Compara tus
                  favoritos.
                </p>
              </div>
                  ...
                  >
                    ...
                    <div className="absolute top-6 right-6 md:top-10 md:right-10 z-20 flex flex-col gap-3">
                      <button
                        ...
                        className={cn(
                          ...
                          comparisonIds.includes(hotel.id)
                            ? 'bg-brand-gold text-white'
                            : 'bg-white/90 backdrop-blur text-brand-dark hover:bg-brand-dark hover:text-white'
                        )}
                      >
                    ...
                    <div className="relative h-[400px] md:h-[600px] overflow-hidden">
                      ...
                      <div className="absolute bottom-8 left-8 right-8 md:bottom-12 md:left-12 md:right-12 text-white space-y-4 md:space-y-6">
                        <h3 className="text-3xl md:text-5xl font-serif leading-none">
                          {hotel.name}
                        </h3>
                        <p className="text-white/60 font-light text-sm md:text-lg max-w-md line-clamp-2 md:line-clamp-none">
                          {'description' in hotel ? String(hotel.description ?? '') : ''}
                        </p>
                        <div className="flex flex-wrap gap-2 md:gap-4">
                          {'perks' in hotel &&
                            Array.isArray(hotel.perks) &&
                            hotel.perks.map((p: string, i: number) => (
                              <span
                                key={i}
                                className="px-3 py-1.5 md:px-4 md:py-2 bg-white/10 backdrop-blur rounded-full text-[8px] md:text-[9px] font-bold uppercase tracking-widest"
                              >
                                {p}
                              </span>
                            ))}
                    ...
                    <div className="p-8 md:p-16 space-y-8 md:space-y-12">
                      <div className="grid grid-cols-1 gap-6 md:gap-10">
                        {hotel.packages.map((pkg) => (
                          <div
                            key={pkg.id}
                            className="flex flex-col sm:flex-row justify-between items-center gap-6 p-6 md:p-8 rounded-[2rem] md:rounded-[3rem] bg-brand-paper/50 border border-brand-dark/5"
                          >
                            <div className="space-y-1 md:space-y-2 text-center sm:text-left">
                              <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-brand-gold">
                                Paquete {pkg.name}
                              </h4>
                              <p className="text-3xl md:text-4xl font-serif">
                                {pkg.currency} {pkg.basePrice.toLocaleString()}
                              </p>
                              <p className="text-[8px] md:text-[10px] text-brand-dark/30 uppercase tracking-widest">
                                Base {pkg.minGuests} PAX
                              </p>
                            </div>
                            <button
                              onClick={() => {
            ...
            <div className="py-20 md:py-32 bg-brand-dark text-white rounded-[3rem] md:rounded-[6rem] px-8 md:px-20 space-y-16">
              <div className="max-w-3xl space-y-6">
                <h3 className="text-brand-gold uppercase tracking-[0.4em] text-[10px] font-bold">
                  The Flymingo Edge
                </h3>
                <h2 className="text-4xl md:text-6xl font-serif leading-tight">
                  ¿Por qué diseñar con <span className="italic text-brand-gold">Flymingo</span>?
                </h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-20">
                {[
                  {
                    title: 'Curaduría AI',
                    desc: 'Algoritmos que analizan miles de datos para encontrar tu match perfecto.',
                    icon: Sparkles,
                  },
                  {
                    title: 'Beneficios Elite',
                    desc: 'Acceso a upgrades y cortesías que no encontrarás en ningún otro lugar.',
                    icon: Zap,
                  },
                  {
                    title: 'Soporte 24/7',
                    desc: 'Un equipo de expertos listos para resolver cualquier duda al instante.',
                    icon: MessageSquare,
                  },
                ].map((item, i) => {
        ...
        return (
          <div className="max-w-7xl mx-auto space-y-12 md:space-y-20 py-6 md:py-12 px-4">
            <div className="text-center space-y-6">
              ...
              <h2 className="text-5xl md:text-8xl font-serif leading-none tracking-tighter">
                Duelo de <br />
                <span className="italic text-brand-gold">Titanes</span>
              </h2>
              <p className="text-brand-dark/40 text-lg font-light max-w-lg mx-auto">
                Compara los beneficios exclusivos y la inversión para tus destinos favoritos.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              {comparedHotels.map((hotel) => {
                const firstPackage = hotel.packages[0];
                  ...
                  <div key={hotel.id} className="bg-white rounded-[4rem] luxury-shadow overflow-hidden">
                    <div className="h-64 relative">
                      ...
                      <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                        <h3 className="text-3xl text-white font-serif text-center px-8">
                          {hotel.name}
                        </h3>
                      </div>
                    </div>
                    ...
                    <div className="p-12 space-y-10">
                      <div className="space-y-6">
                        <h4 className="text-xs font-bold uppercase tracking-widest text-brand-gold border-b border-brand-dark/5 pb-4">
                          Flymingo Perks
                        </h4>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                          <p className="text-2xl font-serif">{firstPackage.name}</p>
                          <p className="text-4xl font-serif text-brand-dark">
                            {firstPackage.currency} {firstPackage.basePrice.toLocaleString()}
                          </p>
                        </div>
                      </div>
                      ...
                      <button
                        onClick={() => {
                          setSelectedPackage({ hotel, package: firstPackage });
                          nextStep('summary');
                        }}
      ...
      case 'summary': {
        ...
        const extraPaxPrice = 'extraPaxPrice' in pkg ? pkg.extraPaxPrice : 0;
        const hasExtraGuestPricing = extraPaxPrice > 0;
        const extraCost = extraGuests * extraPaxPrice;
          ...
          <div className="max-w-7xl mx-auto py-6 md:py-12 px-4">
            <div className="grid lg:grid-cols-12 gap-12 md:gap-24">
              <div className="lg:col-span-7 space-y-12 md:space-y-16">
                <button
                  onClick={() => prevStep('results')}
                  className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-[0.3em] text-brand-dark/30 hover:text-brand-dark transition-colors"
                >
                ...
                <div className="space-y-6 md:space-y-8">
                  <div className="space-y-2 md:space-y-4">
                    <h2 className="text-brand-gold uppercase tracking-[0.6em] text-[8px] md:text-[10px] font-bold">
                      Digital Vision Dossier
                    </h2>
                    <h1 className="text-5xl md:text-8xl font-serif leading-[0.85] tracking-tighter">
                      {selectedPackage.hotel.name}
                    </h1>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-12 md:gap-16">
                  <div className="space-y-6 md:space-y-8">
                    <h3 className="text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] border-b border-brand-dark/10 pb-4 md:pb-6">
                      Inclusiones Signature
                    </h3>
                    <div className="space-y-4 md:space-y-5">
                      {pkg.inclusions.map((inc: string, i: number) => (
                        <div
                          key={i}
                          className="flex items-start gap-4 md:gap-5 text-sm text-brand-dark/60 font-medium"
                        >
                  ...
                  <div className="space-y-6 md:space-y-8">
                    <h3 className="text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] border-b border-brand-dark/10 pb-4 md:pb-6">
                      Flymingo Perks Unlocked
                    </h3>
                    <div className="space-y-4 md:space-y-6">
                      {pkg.flymingoPerks.map((perk: string, i: number) => (
                        <div
                          key={i}
                          className="flex items-center gap-4 md:gap-5 p-5 md:p-6 bg-brand-dark text-white rounded-[2rem] md:rounded-[2.5rem] shadow-xl"
                        >
                          <Sparkles className="w-5 h-5 md:w-6 md:h-6 text-brand-gold flex-shrink-0" />
                          <span className="text-[9px] md:text-[11px] font-bold uppercase tracking-widest leading-tight">
                            {perk}
                          </span>
                        </div>
                      ))}
              ...
              <div className="lg:col-span-5">
                <div className="bg-white p-8 md:p-16 rounded-[3rem] md:rounded-[5rem] luxury-shadow sticky top-12 space-y-8 md:space-y-12 border border-brand-dark/5">
                  <div className="text-center space-y-2 md:space-y-3">
                    ...
                    <p className="text-[8px] md:text-[10px] font-bold uppercase tracking-[0.4em] text-brand-dark/20">
                      Cotización Flymingo Premium
                    </p>
                  </div>

                  <div className="space-y-6 md:space-y-8 border-y border-brand-dark/5 py-8 md:py-10">
                    <div className="flex justify-between items-center">
                      <span className="text-brand-dark/30 font-bold uppercase tracking-widest text-[8px] md:text-[10px]">
                        Paquete Base
                      </span>
                    ...
                    {extraGuests > 0 && hasExtraGuestPricing && (
                      <div className="flex justify-between items-center">
                        <span className="text-brand-dark/30 font-bold uppercase tracking-widest text-[8px] md:text-[10px]">
                          Invitados Extra ({extraGuests})
                        </span>
                        <span className="font-serif text-xl md:text-2xl">
                          {pkg.currency} {extraCost.toLocaleString()}
                        </span>
                      </div>
                    )}

                    <div className="pt-4 md:pt-6 flex flex-col items-center gap-1 md:gap-2">
                      <span className="text-brand-dark font-bold uppercase tracking-[0.5em] text-[8px] md:text-[9px]">
                        Total Estimado
                      </span>
                      <span className="text-5xl md:text-7xl font-serif text-brand-gold leading-none tracking-tighter">
                        {pkg.currency} {totalCost.toLocaleString()}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="flex flex-col gap-4">
                      <button className="w-full py-6 md:py-7 bg-brand-dark text-white rounded-full text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] hover:bg-brand-gold transition-all shadow-2xl shadow-brand-dark/20 group">
                        Descargar Dossier Digital{' '}
                        <ArrowRight className="inline-block ml-2 md:ml-3 w-4 h-4 group-hover:translate-x-2 transition-transform" />
                      </button>
                    ...
                    <p className="text-[8px] md:text-[9px] text-center text-brand-dark/30 uppercase tracking-widest leading-relaxed">
                      Al solicitar el dossier, un especialista de Flymingo <br className="hidden md:block" />
                      se pondrá en contacto para una sesión de diseño 1:1.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="fixed top-0 left-0 w-full z-[100] px-6 py-4 flex justify-between items-center bg-brand-paper/80 backdrop-blur-lg border-b border-brand-dark/5 lg:bg-transparent lg:backdrop-blur-none lg:border-none lg:relative lg:p-10">
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="font-serif text-xl md:text-2xl tracking-tighter leading-none">
              Flymingo
            </span>
            <span className="text-[8px] md:text-[10px] font-bold uppercase tracking-[0.5em] text-brand-gold">
              Weddings
            </span>
          </div>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-12 text-[10px] font-bold uppercase tracking-[0.3em] text-brand-dark/30">
          {['vision', 'destination', 'guests', 'results'].map((s, i) => (
            <div key={s} className="flex items-center gap-4">
              <span className={cn('transition-colors', step === s ? 'text-brand-gold' : '')}>
                0{i + 1} {s}
              </span>
          ...
          >
            ...
            {step !== 'results' && step !== 'comparison' && (
              <button
                ...
                disabled={
                  (step === 'vision' && !selections.vision) ||
                  (step === 'destination' && !selections.destination)
                }
